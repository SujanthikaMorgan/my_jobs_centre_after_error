      ...
      child: Container(
        ...
        child: Stack(
          children: <Widget>[
            ...
            // Connect
            Pinned.fromPins(
                Pin(size: 106.5, middle: 0.7303), Pin(size: 24.0, middle: 0.6902),
                child: PageLink(
                  links: [
                    PageLinkInfo(
                      transition: LinkTransition.Fade,
            ...
            // Job alerts
            Pinned.fromPins(
              Pin(size: 117.0, middle: 0.7582),
              Pin(size: 22.0, middle: 0.6204),
              child: PageLink(
                links: [
                  PageLinkInfo(
                    transition: LinkTransition.Fade,
            ...
            //Fav Jobs
            Pinned.fromPins(
              Pin(size: 113.2, middle: 0.7335),
              Pin(size: 22.0, middle: 0.5523),
              child: PageLink(
                links: [
                  PageLinkInfo(
                    transition: LinkTransition.Fade,
            ...
            //My resumes
            Pinned.fromPins(
              Pin(size: 136.0, end: 47.0),
              Pin(size: 25.6, middle: 0.4081),
              child: PageLink(
                links: [
                  PageLinkInfo(
                    transition: LinkTransition.Fade,
                    ...
                    Pinned.fromPins(
                      ...
                      child:
                        ...
                        children: <Widget>[
                          ...
                          Pinned.fromPins(
                            Pin(size: 8.4, middle: 0.3188),
                            Pin(size: 1.2, middle: 0.6153),
                            child: SvgPicture.string(
                              _svg_iqp42,
                              allowDrawingOutsideViewBox: true,
                              fit: BoxFit.fill,
                          ...
                          Pinned.fromPins(
                            Pin(size: 4.3, middle: 0.2833),
                            Pin(size: 4.3, middle: 0.1906),
                            child: SvgPicture.string(
                              _svg_b2w46j,
                              allowDrawingOutsideViewBox: true,
                              fit: BoxFit.fill,
                          ...
                          Pinned.fromPins(
                            Pin(size: 5.8, middle: 0.259),
                            Pin(size: 3.9, middle: 0.4031),
                            child: SvgPicture.string(
                              _svg_h67t4d,
                              allowDrawingOutsideViewBox: true,
                              fit: BoxFit.fill,
            ...
            //Job Seekers
            Pinned.fromPins(
              Pin(size: 132.5, end: 50.5),
              Pin(size: 24.0, middle: 0.761),
              child: PageLink(
                links: [
                  PageLinkInfo(
                    transition: LinkTransition.Fade,
            ...
            //Companies
            Pinned.fromPins(
              Pin(size: 127.8, end: 53.5),
              Pin(size: 24.4, end: 137.6),
              child: PageLink(
                links: [
                  PageLinkInfo(
                    transition: LinkTransition.Fade,
                    ease: Curves.easeOut,
                    duration: 0.3,
                    // pageBuilder: () => Companies(),
                  ),
                ],
                child: Stack(
                  children: <Widget>[
                    Pinned.fromPins(
                      Pin(start: 40.8, end: 0.0),
