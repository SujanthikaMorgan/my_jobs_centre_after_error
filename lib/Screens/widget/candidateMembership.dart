...
class CandidateMembership extends StatefulWidget {
  final String title;
  final String price;
  final String period;
  ...
  @override
  State<CandidateMembership> createState() => _CandidateMembershipState();
}

class _CandidateMembershipState extends State<CandidateMembership> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: 15, top: 15),
                    child: Text(
                      'Features of ${widget.title} premium',
                      style: TextStyle(
                          fontFamily: 'Poppins',
                          color: Colors.black,
                          fontSize: 20,
                  ...
                  featureAdd('10 Keys (To Unlock Employers)', check),
                  featureAdd('Unlimited chats to reach out to employers.', check),
                  featureAdd('Extend your application for more than 72 hours.', check),
                  featureAdd('Obtain a Verified badge.', check),
                  Padding(
