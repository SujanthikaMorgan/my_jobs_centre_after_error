// ignore_for_file: file_names, unnecessary_new, use_key_in_widget_constructors, prefer_const_constructors, prefer_const_literals_to_create_immutables
...
import 'widget/socialLinksWidget.dart';
...
class JobDetailsScreen extends StatefulWidget {
  static const String idScreen = 'JobDetailsScreen';
...
class _JobDetailsScreenState extends State<JobDetailsScreen> {
  ...
  Future msgSend() async {
    // var url = Uri.parse('http://10.0.2.2/myjobscenter/demo/mob_new_message');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
                    ...
                    child: GestureDetector(
                      ...
                      child: Padding(
                        ...
                        child: Icon(
                          ...
                          color: isFavLoc ? Color(0xffdd312d) : Colors.black,
                        ),
                      ),
                    ),
                  ),
              ...
              if (widget.minSal.toString() != "0" || widget.maxSal.toString() != "0")
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        // child: Text(
                        //   '$minSal - $maxSal $currency per $salType',
                        //   style: TextStyle(
                        //     fontFamily: 'Poppins',
                        //     fontSize: 14,
      ...
      floatingActionButton:
          (widget.isApplyShow && userDetailsResponse['user_type'] != "employer")
              ? Align(
