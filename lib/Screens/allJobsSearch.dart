...
class AllJobsSearch extends StatefulWidget {
  static const String idScreen = "allJobsSearch";
  final String? searchTermRec;
  const AllJobsSearch({Key? key, this.searchTermRec}) : super(key: key);

  @override
  _AllJobsSearchState createState() => _AllJobsSearchState();
}

class _AllJobsSearchState extends State<AllJobsSearch> {
...
// var dbFavJob = new Mysql();
  ...
  Future gettingAllJobs() async {
    ...
    setState(() {
      ...
      pageData['keyword'] = searchKeyword;
  ...
  @override
  void initState() {
    if (widget.searchTermRec != null) {
      setState(() {
        searchTextController.text = widget.searchTermRec!;
        searchKeyword = widget.searchTermRec!;
      });
    }
    gettingFavJobsIds();
    gettingAllJobs();
