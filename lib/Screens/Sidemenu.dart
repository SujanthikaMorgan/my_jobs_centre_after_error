...
import 'package:my_jobs_center/Screens/candidatesMembPage.dart';
import 'package:page_transition/page_transition.dart';
// import 'package:my_jobs_center/Screens/data/My_Resumes.dart';
import '../employer/employer screens/transactionsPage.dart';
...
class _SidemenuState extends State<Sidemenu> {
  ...
  String categorySub = '-';
//resultProfPic,profPic
  @override
  void initState() {
    // _dbCheck();
    // _dbCheckCategorySubSelected();
  }
          ...
          children: [
            ...
            isSignedIn
                ? Align(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.only(left: 30, bottom: 30, top: 15),
...
const String company =
    '<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 36 36"><rect x="0" y="0" width="36" height="36" fill="none" stroke="none" /><path fill="#788197" d="M31 8h-8v2h8v21h-8v2h10V10a2 2 0 0 0-2-2Z" class="clr-i-outline clr-i-outline-path-1"/><path fill="#788197" d="M19.88 3H6.12A2.12 2.12 0 0 0 4 5.12V33h18V5.12A2.12 2.12 0 0 0 19.88 3ZM20 31h-3v-3H9v3H6V5.12A.12.12 0 0 1 6.12 5h13.76a.12.12 0 0 1 .12.12Z" class="clr-i-outline clr-i-outline-path-2"/><path fill="#788197" d="M8 8h2v2H8z" class="clr-i-outline clr-i-outline-path-3"/><path fill="#788197" d="M12 8h2v2h-2z" class="clr-i-outline clr-i-outline-path-4"/><path fill="#788197" d="M16 8h2v2h-2z" class="clr-i-outline clr-i-outline-path-5"/><path fill="#788197" d="M8 13h2v2H8z" class="clr-i-outline clr-i-outline-path-6"/><path fill="#788197" d="M12 13h2v2h-2z" class="clr-i-outline clr-i-outline-path-7"/><path fill="#788197" d="M16 13h2v2h-2z" class="clr-i-outline clr-i-outline-path-8"/><path fill="#788197" d="M8 18h2v2H8z" class="clr-i-outline clr-i-outline-path-9"/><path fill="#788197" d="M12 18h2v2h-2z" class="clr-i-outline clr-i-outline-path-10"/><path fill="#788197" d="M16 18h2v2h-2z" class="clr-i-outline clr-i-outline-path-11"/><path fill="#788197" d="M8 23h2v2H8z" class="clr-i-outline clr-i-outline-path-12"/><path fill="#788197" d="M12 23h2v2h-2z" class="clr-i-outline clr-i-outline-path-13"/><path fill="#788197" d="M16 23h2v2h-2z" class="clr-i-outline clr-i-outline-path-14"/><path fill="#788197" d="M23 13h2v2h-2z" class="clr-i-outline clr-i-outline-path-15"/><path fill="#788197" d="M27 13h2v2h-2z" class="clr-i-outline clr-i-outline-path-16"/><path fill="#788197" d="M23 18h2v2h-2z" class="clr-i-outline clr-i-outline-path-17"/><path fill="#788197" d="M27 18h2v2h-2z" class="clr-i-outline clr-i-outline-path-18"/><path fill="#788197" d="M23 23h2v2h-2z" class="clr-i-outline clr-i-outline-path-19"/><path fill="#788197" d="M27 23h2v2h-2z" class="clr-i-outline clr-i-outline-path-20"/><path fill="none" d="M0 0h36v36H0z"/></svg>';
//'<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 256 256"><path fill="#788197" d="M240 208h-8V104a16 16 0 0 0-16-16h-64V40a16 16 0 0 0-16-16H40a16 16 0 0 0-16 16v168h-8a8 8 0 0 0 0 16h224a8 8 0 0 0 0-16Zm-120-72a8 8 0 0 1-8 8H80a8 8 0 0 1 0-16h32a8 8 0 0 1 8 8ZM64 64h32a8 8 0 0 1 0 16H64a8 8 0 0 1 0-16Zm0 104h32a8 8 0 0 1 0 16H64a8 8 0 0 1 0-16Zm88-64h64v104h-64Zm48 72a8 8 0 0 1-8 8h-16a8 8 0 0 1 0-16h16a8 8 0 0 1 8 8Zm-32-40a8 8 0 0 1 8-8h16a8 8 0 0 1 0 16h-16a8 8 0 0 1-8-8Z"/></svg>';
const String notify =
    '<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 36 36"><rect x="0" y="0" width="36" height="36" fill="none" stroke="none" /><path fill="#788197" d="M18 34.28A2.67 2.67 0 0 0 20.58 32h-5.26A2.67 2.67 0 0 0 18 34.28Z" class="clr-i-outline--badged clr-i-outline-path-1--badged"/><path fill="#788197" d="M32.51 27.83A14.4 14.4 0 0 1 30 24.9a12.63 12.63 0 0 1-1.35-4.81v-4.94a10.92 10.92 0 0 0-.16-1.79a7.44 7.44 0 0 1-2.24-.84a8.89 8.89 0 0 1 .4 2.64v4.94a14.24 14.24 0 0 0 1.65 5.85a16.17 16.17 0 0 0 2.44 3H5.13a16.17 16.17 0 0 0 2.44-3a14.24 14.24 0 0 0 1.65-5.85v-4.95A8.8 8.8 0 0 1 18 6.31a8.61 8.61 0 0 1 4.76 1.44A7.49 7.49 0 0 1 22.5 6v-.63a10.58 10.58 0 0 0-3.32-1V3.11a1.33 1.33 0 1 0-2.67 0v1.31a10.81 10.81 0 0 0-9.3 10.73v4.94a12.63 12.63 0 0 1-1.35 4.81a14.4 14.4 0 0 1-2.47 2.93a1 1 0 0 0-.34.75v1.36a1 1 0 0 0 1 1h27.8a1 1 0 0 0 1-1v-1.36a1 1 0 0 0-.34-.75Z" class="clr-i-outline--badged clr-i-outline-path-2--badged"/><circle cx="30" cy="6" r="5" fill="#788197" class="clr-i-outline--badged clr-i-outline-path-1--badged clr-i-badge"/><path fill="none" d="M0 0h36v36H0z"/></svg>';
    //'<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 36 36"><path fill="#788197" d="M18 34.28A2.67 2.67 0 0 0 20.58 32h-5.26A2.67 2.67 0 0 0 18 34.28Z" class="clr-i-outline--badged clr-i-outline-path-1--badged"/><path fill="#788197" d="M32.51 27.83A14.4 14.4 0 0 1 30 24.9a12.63 12.63 0 0 1-1.35-4.81v-4.94a10.92 10.92 0 0 0-.16-1.79a7.44 7.44 0 0 1-2.24-.84a8.89 8.89 0 0 1 .4 2.64v4.94a14.24 14.24 0 0 0 1.65 5.85a16.17 16.17 0 0 0 2.44 3H5.13a16.17 16.17 0 0 0 2.44-3a14.24 14.24 0 0 0 1.65-5.85v-4.95A8.8 8.8 0 0 1 18 6.31a8.61 8.61 0 0 1 4.76 1.44A7.49 7.49 0 0 1 22.5 6v-.63a10.58 10.58 0 0 0-3.32-1V3.11a1.33 1.33 0 1 0-2.67 0v1.31a10.81 10.81 0 0 0-9.3 10.73v4.94a12.63 12.63 0 0 1-1.35 4.81a14.4 14.4 0 0 1-2.47 2.93a1 1 0 0 0-.34.75v1.36a1 1 0 0 0 1 1h27.8a1 1 0 0 0 1-1v-1.36a1 1 0 0 0-.34-.75Z" class="clr-i-outline--badged clr-i-outline-path-2--badged"/><circle cx="30" cy="6" r="5" fill="#788197" class="clr-i-outline--badged clr-i-outline-path-1--badged clr-i-badge"/><path fill="none" d="M0 0h36v36H0z"/></svg>';
    //'<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="#788197" d="M12 22a2.02 2.02 0 0 1-2.01-2h4a2.02 2.02 0 0 1-.149.78a2.043 2.043 0 0 1-1.44 1.18h-.046A1.944 1.944 0 0 1 12 22Zm8-3H4v-2l2-1v-5.5a8.065 8.065 0 0 1 .924-4.06A4.654 4.654 0 0 1 10 4.18V2h4v2.18c2.579.614 4 2.858 4 6.32V16l2 1v2Zm1.97-9h-2a8.672 8.672 0 0 0-3.39-6.57L18 2a9.9 9.9 0 0 1 2.825 3.486A11.52 11.52 0 0 1 21.97 10ZM4 10H2c.07-1.567.46-3.103 1.145-4.514A9.9 9.9 0 0 1 5.97 2l1.42 1.43A8.67 8.67 0 0 0 4 10Z"/></svg>';