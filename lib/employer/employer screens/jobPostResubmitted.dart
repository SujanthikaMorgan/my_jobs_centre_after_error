...
class JobPostResubmitted extends StatefulWidget {
  const JobPostResubmitted({Key? key}) : super(key: key);

  @override
  _JobPostResubmittedState createState() => _JobPostResubmittedState();
}

class _JobPostResubmittedState extends State<JobPostResubmitted> {
  Map pageData = {};
  int offset = 1;
  Map myJobs = {};
  var myJobsList = [];
  ...
  Future gettingAllJobs() async {
    ...
    var url = Uri.parse(defaultUrl + 'mob_my_jobs_resubmitted');
                                      ...
                                      GestureDetector(
                                        ...
                                        child: JobsWidget(
                                          ...
                                          subCat: myJobs['all'][myJobsList[i].toString()]
                                                  ['sub_category']
                                              .toString(),
                                          tags: myJobs['all'][myJobsList[i].toString()]
                                                  ['tag']
                                              .toString(),
                                          ...
                                          totalAplications: myJobs['all']
                                              ...
                                              .toString(),
                                          featured: myJobs['all']
                                                  [myJobsList[i].toString()]['featured']
                                              .toString(),
                                          highlight: myJobs['all']
                                                  [myJobsList[i].toString()]['highlight']
                                              .toString(),
