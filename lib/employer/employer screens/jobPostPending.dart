...
class JobPostPending extends StatefulWidget {
  const JobPostPending({Key? key}) : super(key: key);

  @override
  _JobPostPendingState createState() => _JobPostPendingState();
}

class _JobPostPendingState extends State<JobPostPending> {
  Map pageData = {};
  int offset = 1;
  Map myJobs = {};
  var myJobsList = [];
  ...
  Future gettingAllJobs() async {
    ...
    var url = Uri.parse(defaultUrl + 'mob_my_jobs_pending');
