...
class JobPostClosed extends StatefulWidget {
  const JobPostClosed({Key? key}) : super(key: key);

  @override
  _JobPostClosedState createState() => _JobPostClosedState();
}

class _JobPostClosedState extends State<JobPostClosed> {
  Map pageData = {};
  int offset = 1;
  Map myJobs = {};
  var myJobsList = [];
  ...
  Future gettingAllJobs() async {
    ...
    var url = Uri.parse(defaultUrl + 'mob_my_jobs_closed');
