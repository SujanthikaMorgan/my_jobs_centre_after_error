...
class JobSeekersPreviewPage extends StatefulWidget {
  const JobSeekersPreviewPage({Key? key}) : super(key: key);

  @override
  _JobSeekersPreviewPageState createState() => _JobSeekersPreviewPageState();
}

class _JobSeekersPreviewPageState extends State<JobSeekersPreviewPage> {
  Map pageData = {};
  int offset = 1;
  Map alljobs = {};
  Map alljobs1 = {};
  ...
  Future gettingAllJobseekers() async {
    ...
    var url = Uri.parse(defaultUrl + 'mob_job_seekers');
                        ...
                        children: [
                          for (int i = 0; i < allJobsList.length; i++)
                            JobSeekerPreviewWidget(
                              city: (alljobs['all'][allJobsList[i].toString()]['city'] ==
                                      null)
                                  ? " "
                              ...
                              description: (alljobs['all'][allJobsList[i].toString()]
                                  ...
                                  : alljobs['all'][allJobsList[i].toString()]
                                      ['description'],
                              imagePath: alljobs['all'][allJobsList[i].toString()]
                                  ['image'],
                              mainCat: (alljobs['all'][allJobsList[i].toString()]
                                          ['category'] ==
                                      null)
                                  ? ""
                              ...
                              minSal: (alljobs['all'][allJobsList[i].toString()]
                                  ...
                                  : alljobs['all'][allJobsList[i].toString()]
                                      ['salary_min'],
                              name: (alljobs['all'][allJobsList[i].toString()]['name'] ==
                                      null)
                                  ? " "
                                  : alljobs['all'][allJobsList[i].toString()]['name'],
                              // salType: alljobs['all'][allJobsList[i].toString()]['city'],
                              tagline: (alljobs['all'][allJobsList[i].toString()]
                                          ['tagline'] ==
                                      null)
                                  ? " "
                              ...
                              isBlocked: (blockedIds.contains(
                                  alljobs['all'][allJobsList[i].toString()]['id'])),
                              userName: alljobs['all'][allJobsList[i].toString()]
                                  ['username'],
                            )
                        ],
                      ),
