...
class JobPostExpired extends StatefulWidget {
  const JobPostExpired({Key? key}) : super(key: key);

  @override
  _JobPostExpiredState createState() => _JobPostExpiredState();
}

class _JobPostExpiredState extends State<JobPostExpired> {
  Map pageData = {};
  int offset = 1;
  Map myJobs = {};
  var myJobsList = [];
  ...
  Future gettingAllJobs() async {
    ...
    var url = Uri.parse(defaultUrl + 'mob_my_jobs_expired');
