...
class BusinessMembership extends StatelessWidget {
  const BusinessMembership({Key? key}) : super(key: key);
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  featureAdd('Ad Post Limit : 150', check),
                  featureAdd('Ad expiry in : 365 days', check),
                  featureAdd(' Featured ad fee £15.00 for 30 days', check),
                  featureAdd('Urgent ad fee £15.00 for 30 days', check),
                  featureAdd('Highlight ad fee £15.00 for 30 days', check),
                  featureAdd('Top in search results and category', check),
